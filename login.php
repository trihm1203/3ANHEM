...
<div class="form">
    ...
    <div class="form-panel one">
        <div class="form-header">
            ...
            <div class="form-group">
                <input style="background-color: #FFD333;" type="submit" name="dangnhap" value="ĐĂNG NHẬP">
            </div>
            <p>Nếu bạn chưa có tài khoản. Vui lòng đăng ký. <a href="index.php?pg=register"> Tại đây</a> </p>
